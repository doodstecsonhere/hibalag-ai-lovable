...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hibalag AI — Silliman 125th Founders Day" },
      { name: "description", content: "Bisaya-speaking AI guide to Silliman University's 125th Founders Day and Hibalag Festival, August 2026." },
      ...
      { property: "og:description", content: "Your guide to Hibalag Festival 2026." },
